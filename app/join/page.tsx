        ...
        <div className={styles.content}>
            ...
            <div>
                ...
                <div className={styles.seminar}>
                    <div className={styles.esaImageWrapper}>
                        <ResponsiveImage
                    ...
                    <div className={styles.esaDescription}>
